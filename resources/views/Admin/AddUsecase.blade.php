							...
							<div class="nftmax-body">
								...
								<div class="nftmax-dsinner">
									...
									<div class="nftmax-inner__heading">
										<h2 class="nftmax-inner__page-title">Create new Usecase</h2>
									</div>
									<!-- End All Notification Heading -->
									
									<div class="nftmax__item">
										<form class="form" action="{{route('add-use-case')}}" method="POST">
                                            @csrf
											<div class="row">
												<div class="col-12">
																...
																<div class="nftmax__item-form--main">
																	...
																	<div class="nftmax__item-form--group ntfmax__item-form--radio">
																		<div class="ntfmax__item-radio--inner">
																			<label class="nftmax__item-label">Add your usecase here <span class="nftmax__item-sublabel">Enter price to allow users instantly purchase your plane</span></label>
																
																		</div>
																	</div>
																	
																	<div class="nftmax__item-form--group">
																		<label class="nftmax__item-label">Title </label>
																		<input class="nftmax__item-input" type="text" name="title" placeholder="Usecase  Title" required="required">
																	</div>

                                                                    <div class="nftmax__item-form--group">
																		<label class="nftmax__item-label">Description </label>
																		<textarea class="nftmax__item-input nftmax__item-textarea" name="usecase" placeholder="provide a detailed description of your item." required="required"></textarea>
																	</div>	
